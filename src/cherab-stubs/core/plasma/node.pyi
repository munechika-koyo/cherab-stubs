...
class Composition:
    ...
    def set(self, species: Iterable[Species]) -> None:
        """
...
class ModelManager:
    ...
    def set(self, models: Iterable[PlasmaModel]) -> None: ...
...
class Plasma(Node):
    ...
    @composition.setter
    def composition(self, values: Iterable[Species]) -> None: ...
    ...
    @models.setter
    def models(self, values: Iterable[PlasmaModel]) -> None: ...
    @property
