...
class Element:
    ...
    def __init__(self, name: str, symbol: str, atomic_number: int, atomic_weight: float) -> None: ...
...
class Isotope(Element):
    ...
    def __init__(self, name: str, symbol: str, element: Element, mass_number: int, atomic_weight: float) -> None: ...
    def __repr__(self) -> str: ...
    def __hash__(self) -> int: ...
