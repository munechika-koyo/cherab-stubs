...
def add_beam_stopping_rate(beam_species: Element, target_ion: Element, target_charge: int, rate: Mapping[str, object], repository_path: _Path | None = None) -> None:
    """
...
def update_beam_stopping_rates(rates: Mapping[object, object], repository_path: _Path | None = None) -> None:
    """
...
def get_beam_stopping_rate(beam_species: Element, target_ion: Element, target_charge: int, repository_path: _Path | None = None) -> _Rate:
    """
